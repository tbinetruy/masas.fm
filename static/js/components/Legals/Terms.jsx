...
const Terms = props => (
	<div className="legals-content">
		<h3>Welcome to</h3>
			...
			<h2>MASAS - 'Make A Sound And Share' Terms of Use</h2>

			<p>These Terms of Use govern your use of MASAS.fm and m.MASAS.fm (representing, together, the 'Website'), our mobile applications (our 'Apps') and all related players, widgets, tools, applications, data, software, APIs (the APIs may also be subject to seperate API Terms of Use) and other services provided by MASAS.</p>

			<p>These Terms of Use, <a href='legals2'>Privacy Policy</a>, <a href='legals3'>Cookies Policy</a>, <a href='legals4'>Communal Guidelines</a>, and <a href='legals5'>The Copyright Laws</a>, and any other terms specifically referred to in any of those documents, constitute a legally binding agreement (our ' Agreement') between you and MASAS in relation to your use of the Website, Applications and Services ('Platform').</p>

			<p> Respect the platform and its users by following this terms of uses please. </p>


			<h2>Acceptance of the Terms of Use</h2>

			<p>Please, carefully read our Terms of Use, <a href='legals2'>Privacy Policy</a>, <a href='legals3'>Cookies Policy</a>, <a href='legals4'>Communal Guidelines</a>, and <a href='legals5'>the copyright laws</a>. If you do not agree to any of the provisions set forth in those documents, you should not use any of our Websites, Apps, and any other services that we provide. By accessing and using our platform, setting up an account, viewing, accessing or streaming, uploading or downloading any information or content from or to the Platform, you represent and warrant that you have read and understood the Terms of Use, <a href='legals2'>Privacy Policy</a>, <a href='legals3'>Cookies Policy</a>, <a href='legals4'>Communal Guidelines</a>, and <a href='legals5'>the copyright laws</a> and that you will obey them. You also warrant that you are either 18 years old or older, or that you are 13 years old and have the permission of your parent(s)' or legal guardian(s)' to use our Platform. </p>

			<p>We strongly advise you to sit down, relax, and take your time to make sure that you fully understand our Terms of Use, <a href='legals2'>Privacy Policy</a>, <a href='legals3'>Cookies Policy</a>, <a href='legals4'>Communal Guidelines</a>, and <a href='legals5'>the copyright laws</a>. </p>


			<h2>Changes to the Terms of Use</h2>

			<p>We reserve the right to alter, replace, or modify these Terms of Use at any point in time. The last modification date is stated at the end of each documents under our Legals section ('Amended on...''). It is your responsibility to check this page from time to time for updates. Any changes or updates that we make to these Terms of Use will be highlighted in this document for a period of twelve (12) weeks following the implementation of it. In addition, if you register an account and these Terms of Use are then changed in any material respect (example: for safety, regulatory, or legal reasons), we will notify you in advance by sending a message to your MASAS account and/or an email to the email address that you have provided to MASAS. The revised Terms of Use will become effective six (6) weeks after changes have been made and notification has been sent. You will not have any obligation to continue using the Platform following any such changes and notification, but if you do not terminate your account as described in the Termination section below during such six (6) week period before effectiveness of the changes, your continuation on the platform ('MASAS') after the end of the period (six (6) weeks) will constitute your acceptance of the revised Terms of Use.</p>


			<h2>Description of the Platform</h2>

			<p>The Platform is a public hosting service. Registered users of the Platform may submit, upload and post audio, text, photos, pictures, graphics, comments, videos and other content such as data or information, which will be stored by MASAS or any third party services that can sync to MASAS (e.g. MASAS uses Facebook's API for each user log-in) at the direction of such registered users, and may be shared and distributed by such registered users, and shared, streamed, freely listened to by other users of our Platform, using the tools and features provided as part of the Platform and accessible via our Websites, Apps and elsewhere. The Platform also enables registered users to interact with one another and to contribute to discussions, and enables any registered users of the Website, Apps or other Services offered by MASAS to view, listen to, stream and share content uploaded and made available by registered users on either the Discover feature of the Platform, the Popular feature, the Feed, your Likes and any Artist's profile as well as enables non-registered users to view, listen to, stream, and share content uploaded and made available by registered users on the Popular feature only.</p>
			...
			<h2>Your MASAS Account</h2>

			<p>You are not obliged to register to use part of our Platform, such as the Popular feature or any other features that is made accessible to non-registered users. Although you are not obliged to register to use part of our platform, you are obligated to register in order to use every features of the Platform provided by our Websites, Apps and/or any other Services provided by us.</p>

			<p>When you register to use the Platform, the minimum that you must provide us is your email address, name, age, and country of residence. You must ensure that all of these informations are, and stay valid. Your email address and any other information you chose to provide about yourself will be treated in accordance with our <a href='legals2'>Privacy Policy.</a>. You are solely responsible for maintaining the confidentiality and security of your log-in information, and you will remain responsible for all use of information enabling logging-in to your account, as well as all activities originating from your account, whether or not such activities were authorized by you.</p>

			<p>If your username or password is lost or stolen, or if you believe that your account has been accessed by unauthorized third parties, you are advised to notify Facebook in writing as well as change or reset your password on Facebook at the earliest possible occasion.</p>

			<p>We reserve the right to disallow, cancel, remove or reassign certain usernames and permalinks in appropriate circumstances as determined by us, with our sole discretion, and may with or without prior notice suspend or terminate your account if activities occur on that account which, in our sole discretion would or might constitute a violation of our Terms of Use, <a href='legals2'>Privacy Policy</a>, <a href='legals3'>Cookies Policy</a>, <a href='legals4'>Communal Guidelines</a>, and <a href='legals5'>the copyright laws</a> or any applicable laws and/or regulations.</p>


			<h2>Your Use of our Platform</h2>

			<p>Subject to your strict compliance with these Terms of Use and our <a href='legals4'>Communal Guidelines</a>, MASAS grants you a limited, personal, non-exclusive, revocable, non-assignable and non-transferable right and license to use the Platform in order to view, listen, stream, share Content uploaded and Content synced from third party websites.</p>

			<p>In addition, if you register to use the Platform, and subject to your strict compliance with these Terms of Use and our <a href='legals4'>Communal Guidelines</a>, MASAS grants you a limited, personal, non-exclusive, revocable, non-assignable and nontransferable right and license to:
				<ol>
					<li>Submit, upload, post, or sync (from Third-Party) Content to the Platform strictly as permitted in accordance with these Terms of Use and the Terms of Use of Third-Party Websites from which content has been synced with MASAS and any other applicable terms posted on the Website from time to time;</li>
					<li>Participate in the community areas and communicate with other members of the MASAS community strictly in accordance with these Terms of Use and our <a href='legals4'>Communal Guidelines</a>; </li>
					<li>Use our Apps and other Services provided as part of the Platform strictly as permitted in accordance with these Terms of Use and any other terms applicable to those Apps or Services.</li>
				</ol>
			</p>

			<p>The above licenses are conditional upon your strict compliance with these Terms of Use and our <a href='legals4'>Communal Guidelines</a>, including, without limitation, the following:
				<ol>
					...
					<li>You must not use any Content (other than Your Content) in any way that is designed to create a separate content service or that replicates any part of the Platform offering.</li>
					...
					<li>You must not alter or remove, attempt to alter or remove, any trademark, copyright or other proprietary or legal notices contained in, or appearing on, the Platform or any Content appearing on the Platform (other than Your Content).</li>
					...
					<li>You must not use the Platform to upload, post, store, transmit, display, copy, distribute, promote, make available or otherwise communicate to the public:
					...
					<li>You must not rent, sell or lease access to the Platform, or any Content on the Platform, although this shall not prevent you from including links from Your Content to any legitimate online download store from where any item of Your Content may be purchased.</li>
			...
			<p>Any Content other than Your Content is the property of the relevant Uploader, and is or may be subject to copyright, trademark rights or other intellectual property or proprietary rights. Such Content may not be downloaded, reproduced, distributed, transmitted, re-uploaded, re-published, displayed, sold, licensed, made available or otherwise communicated to the public or exploited for any purposes except via the features of the Platform. Where you repost another user's Content, or include another user's Content in a set, you acquire no ownership rights whatsoever in that Content. Subject to the rights expressly granted in this section, all rights in Content (and all of its liabilities) are reserved to the relevant Uploader.</p>


			<h2>Representations and Warranties</h2>

			<p>You hereby represent and warrant to MASAS as follows:

				<ol>
					<li>Your Content, and each and every part thereof, is an original work by you, or you have obtained all rights, licenses, consents and permissions necessary in order to use, and (if and where relevant) to authorize MASAS to use, Your Content pursuant to these Terms of Use, including, without limitation, the right to upload, reproduce, store, transmit, distribute, share, publicly display, publicly perform, make available and otherwise communicate to the public Your Content, and each and every part thereof, on, through or via the Website, any and all Services and any Linked Services, .</li>
					<li>Your Content and the availability thereof on the Platform does not and will not infringe or violate the rights of any third party, including, without limitation, any intellectual property rights, performers' rights, rights of privacy or publicity, or rights in confidential information.</li>
					<li>You have obtained any and all necessary consents, permissions and/or releases from any and all persons appearing in Your Content in order to include their name, voice, performance or likeness in Your Content and to publish the same on the Platform and via any Linked Services.</li>
					<li>Your Content, including any comments that you may post on the Website, is not and will not be unlawful, offensive, abusive, defamatory, obscene, racist, sexually explicit, ethnically or culturally offensive, indecent, will not promote violence, terrorism, or illegal acts, or incite hatred, on any grounds, including (but not limited to) race, gender, religion or sexual orientation.</li>
					<li>Your Content does not and will not create any liability on the part of MASAS, its subsidiaries, affiliates, successors, and assigns, and their respective employees, agents, directors, officers and/or shareholders.</li>
				</ol>
			</p>
			...
			<p>MASAS and its subsidiaries, affiliates, successors, assigns, employees, agents, directors, officers and shareholders hereby exclude, to the fullest extent permitted by law, any and all liability which may arise from any Content uploaded to the Platform by users, including, but not limited to, any claims for infringement of intellectual property rights, rights of privacy or publicity rights, any claims relating to publication of defamatory, pornographic, obscene or offensive material, or any claims relating to the completeness, accuracy, currency or reliability of any information provided by users of the Platform. By using the Platform, you irrevocably waive the right to assert any claim with respect to any of the foregoing against MASAS or any of its subsidiaries, affiliates, successors, assigns, employees, agents, directors, officers or shareholders.</p>


			<h2>Reporting Infringements</h2>

			<p>If you discover any Content on our Platform that you believe infringes your copyright, please report this to MASAS either by using the "Report Copyright Infringement" button (associated with every "playing" tracks on the platform), or, by email).</p>

			<p>If you would prefer to send us your own written notification, please make sure that you include the succeeding information:

				<ol>
					<li>A statement that you have identified Content on MASAS that infringes your copyright or the copyright of a third party on whose behalf you are entitled to act;</li>
					<li>A description of the copyright work(s) that you claim have been infringed;</li>
					<li>A description of the Content that you claim is infringing and the MASAS URL(s) where such Content can be located;</li>
					<li>Your full name, address and telephone number, a valid email address on which you can be contacted, and your MASAS user-name if you have one;</li>
			...
			<p>Your notice should be sent to us by email to infringement (@) MASAS.fm and by mail to the following address:

				<ul>
					<li>MASAS SAS, 2 Rue Bellanger, Neuilly-Sur-Seine, France, 92200.</li>
				</ul>

			It is necessary to sent such written notification by email. It is NOT necessary to also send us such written notification by terrestial mail (at the address stated above). </p>

			<p>If you discover Content that infringes any or violates any of your other rights, which you believe is defamatory, pornographic, obscene, racist or otherwise liable to cause widespread offence, or which constitutes impersonation, harassment, spam or otherwise violates these Terms of Use, our Community Guidelines or applicable law, please report this to us using the "Spam" button associated with every track on the platform.</p>



			<h2>Third Party Websites and Services</h2>

			<p>The Platform may provide you with access to third party websites, databases, networks, servers, information, software, programs, systems, directories, applications, products or services.
			MASAS does not have or maintain any control over External Services, and is not and cannot be responsible for their content, operation or use. By linking or otherwise providing access to any External Services, MASAS does not give any representation, warranty or endorsement, express or implied, with respect to the legality, accuracy, quality or authenticity of content, information or services provided by such External Services.
			...
			<p>MASAS will suspend or terminate your access to the Platform that it provides if MASAS determines, in its reasonable discretion, that you have repeatedly breached these Terms of Use or our Community Guidelines.
			...
			<p>IN NO EVENT SHALL MASAS'S AGGREGATE LIABILITY TO YOU UNDER THIS AGREEMENT EXCEED THE GREATER OF 150 EUROS OR THE AMOUNTS (IF ANY) PAID BY YOU TO MASAS DURING THE PREVIOUS TWELVE (12) MONTHS FOR THE SERVICES GIVING RISE TO THE CLAIM.
			MASAS AND ITS SUBSIDIARIES, AFFILIATES, SUCCESSORS, AND ASSIGNS, AND THEIR RESPECTIVE EMPLOYEES, AGENTS, DIRECTORS, OFFICERS AND SHAREHOLDERS, SHALL HAVE NO LIABILITY FOR:
			ANY LOSS OR DAMAGE ARISING FROM:

				<ol>
					<li>YOUR INABILITY TO ACCESS OR USE THE PLATFORM OR ANY PART OR PARTS THEREOF, OR TO ACCESS ANY CONTENT OR ANY EXTERNAL SERVICES VIA THE PLATFORM;</li>
					<li>ANY CHANGES THAT MASAS MAY MAKE TO THE PLATFORM OR ANY PART THEREOF, OR ANY TEMPORARY OR PERMANENT SUSPENSION OR CESSATION OF ACCESS TO THE PLATFORM OR ANY CONTENT IN OR FROM ANY OR ALL TERRITORIES;</li>
					<li>ANY ACTION TAKEN AGAINST YOU BY THIRD PARTY RIGHTSHOLDERS WITH RESPECT TO ANY ALLEGED INFRINGEMENT OF SUCH THIRD PARTY'S RIGHTS RELATING TO YOUR CONTENT OR YOUR USE OF THE PLATFORM, OR ANY ACTION TAKEN AS PART OF AN INVESTIGATION BY MASAS OR ANY RELEVANT LAW ENFORCEMENT AUTHORITY REGARDING YOUR USE OF THE PLATFORM;</li>
					<li>ANY ERRORS OR OMISSIONS IN THE PLATFORM'S TECHNICAL OPERATION, OR FROM ANY INACCURACY OR DEFECT IN ANY CONTENT OR ANY INFORMATION RELATING TO CONTENT;</li>
					<li>YOUR FAILURE TO PROVIDE MASAS WITH ACCURATE OR COMPLETE INFORMATION, OR YOUR FAILURE TO KEEP YOUR USERNAME OR PASSWORD SUITABLY CONFIDENTIAL;</li>
				</ol>
			...
			ANY LOSS OF PROFITS, OR ANY LOSS YOU SUFFER WHICH IS NOT A FORESEEABLE CONSEQUENCE OF MASAS BREACHING THESE TERMS OF USE. LOSSES ARE FORESEEABLE WHERE THEY COULD BE CONTEMPLATED BY YOU AND MASAS AT THE TIME YOU AGREE TO THESE TERMS OF USE, AND THEREFORE DO NOT INCLUDE ANY INDIRECT LOSSES, SUCH AS LOSS OF OPPORTUNITY.
			ANY CLAIM OR CAUSE OF ACTION ARISING OUT OF OR RELATED TO YOUR USE OF THE Platform MUST BE NOTIFIED TO MASAS AS SOON AS POSSIBLE.
			APPLICABLE LAW MAY NOT ALLOW THE LIMITATION OR EXCLUSION OF LIABILITY FOR INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE ABOVE LIMITATIONS OR EXCLUSIONS MAY NOT APPLY TO YOU. IN SUCH CASES, YOU ACKNOWLEDGE AND AGREE THAT SUCH LIMITATIONS AND EXCLUSIONS REFLECT A REASONABLE AND FAIR ALLOCATION OF RISK BETWEEN YOU AND MASAS AND ARE FUNDAMENTAL ELEMENTS OF THE BARGAIN BETWEEN YOU AND MASAS, AND THAT MASAS'S LIABILITY WILL BE LIMITED TO THE MAXIMUM EXTENT PERMITTED BY LAW.
			NOTHING IN THESE TERMS OF USE LIMITS OR EXCLUDES THE LIABILITY OF MASAS, ITS SUBSIDIARIES, SUCCESSORS, ASSIGNS, OR THEIR RESPECTIVE EMPLOYEES, AGENTS, DIRECTORS, OFFICERS AND/OR SHAREHOLDERS:

				<ol>
					<li> FOR ANY DEATH OR PERSONAL INJURY CAUSED BY ITS OR THEIR NEGLIGENCE,</li>
					<li>FOR ANY FORM OF FRAUD OR DECEIT,</li>
					<li>FOR ANY DAMAGES CAUSED WILFULLY OR BY GROSS NEGLIGENCE, OR (IV) FOR ANY FORM OF LIABILITY WHICH CANNOT BE LIMITED OR EXCLUDED BY LAW.</li>
				</ol>
			</p>
			...
			<p>You hereby agree to indemnify, defend and hold harmless MASAS, its successors, assigns, affiliates, agents, directors, officers, employees and shareholders from and against any and all claims, obligations, damages, losses, expenses, and costs, including reasonable attorneys' fees, resulting from:
				<ol>
					<li>Any violation by you of these Terms of Use or our Community Guidelines;</li>
					<li>Any third party claim of infringement of copyright or other intellectual property rights or invasion of privacy arising from the hosting of Your Content on the Platform, and/or your making available thereof to other users of the Platform, and/or the actual use of Your Content by other users of the Platform or Linked Services in accordance with these Terms of Use and the parameters set by you with respect to the distribution and sharing of Your Content;</li>
					<li>Any activity related to your account, be it by you or by any other person accessing your account with or without your consent unless such activity was caused by the act or default of MASAS.</li>
				</ol>
			</p>


			<h2>Data Protection, Privacy and Cookies</h2>

			<p>  All personal data that you provide to us in connection with your use of our Platform is collected, stored, used and disclosed by MASAS in accordance with our Privacy Policy. In addition, in common with most online services, we use cookies to help us understand how people are using the Platform, so that we can continue to improve the service we offer. Our use of cookies, and how to disable cookies, is explained in our Cookies Policy. By accepting these Terms of Use and using the Platform, you also accept the terms of the Privacy Policy and our Cookies Policy.</p>



			<h2>Gatherings</h2>

			<p>MASAS has an active community of users, many of whom organize and attend face-to-face meetings at venues all over the world ('Gatherings'). While MASAS is generally supportive of gatherings and may provide branded promotional materials to help organizers promote their gatherings, MASAS does not sponsor, oversee or in any way control such gatherings. You hereby acknowledge and agree that your attendance and participation in any gatherings is entirely at your own risk and MASAS does not bear any responsibility or liability for the actions of any MASAS users or any third parties who organize, attend or are otherwise involved in any gatherings.</p>



			<h2>Changes to the Platform, Accounts and Pricing</h2>

			<p>MASAS reserves the right at any time and for any reason to suspend, discontinue, terminate or cease providing access to the Platform or any part thereof, temporarily or permanently, and whether in its entirety or with respect to individual territories only. In the case of any temporary or permanent suspension, discontinuation, termination or cessation of access, MASAS shall use its reasonable endeavors to notify registered users of such decision in advance.</p>

			<p>You hereby agree that MASAS and its subsidiaries, affiliates, successors, assigns, employees, agents, directors, officers and shareholders shall not be liable to you or to any third party for any changes or modifications to the Website, Apps and/or any Services that MASAS may wish to make from time to time, or for any decision to suspend, discontinue or terminate the Website, Apps, the Services or any part or parts thereof, or your possibility to use or access the same from or within any territory or territories.</p>

			<p>MASAS may change the features of any type of account, may withdraw, or introduce new features, products or types of account at any time and for any reason, and may change the prices charged for any of its freemium features from time to time.</p>


			<h2>Termination</h2>

			<p>You may terminate this Agreement at any time by removing all of Your Content from your account, by deleting your account and thereafter by ceasing to use the Platform.
			MASAS may suspend your access to the Platform and/or terminate this Agreement at any time if:

				<ol>
					<li>You are deemed to be a Repeat Infringer as described above;</li>
					<li>You are in breach of any of the material provision of these Terms of Use or our Community Guidelines, including without limitation, the provisions of the following sections: Your Use of the Platform, Your Content, Grant of Licence , and Your Representations and Warranties;</li>
					<li>MASAS elects at its discretion to cease providing access to the Platform in the jurisdiction where you reside or from where you are attempting to access the Platform, or</li>
					<li>In other reasonable circumstances as determined by MASAS at its discretion.</li>
				</ol>
			</p>

			<p>Once your account has been terminated, any and all Content residing in your account, or pertaining to activity from your account (for example, your "Likes"), will be irretrievably deleted by MASAS, except to the extent that we are obliged or permitted to retain such content, data or information for a certain period of time in accordance with applicable laws and regulations and/or to protect our legitimate business interests. You are advised to save or back up any material that you have uploaded to your account before terminating your account, as MASAS assumes no liability for any material that is irretrievably deleted following any termination of your account. MASAS is not able to provide you with any .csv or other similar file of data relating to activity associated with your account, whether before or after termination or cancellation. </p>

			<p>If you access the Platform via any of our Apps or via any third party app connected to your account, deleting that app will not delete your account. If you wish to delete your account, you will need to do so from your Settings on your account page on the Website or on the Apps. The provisions of these Terms of Use that are intended by their nature to survive the termination or cancellation of this Agreement will survive the termination of this Agreement, including, but not limited to, those Sections entitled Your MASAS Account, Your Content, Grant of License , Representations and Warranties, Liability for Content, Disclaimer, Limitation, Indemnification, Termination and Right of Cancellation, Assignment to Third Parties, Severability, Entire Agreement, and Applicable Law and Jurisdiction, respectively.</p>


			<h2>Assignment to Third Parties</h2>

			<p>MASAS may assign its rights and (where permissible by law) its obligations under this Agreement, in whole or in part, to any third party at any time without notice, including without limitation, to any person or entity acquiring all or substantially all of the assets or business of MASAS. You may not assign this Agreement or the rights and duties hereunder, in whole or in part, to any third party without the prior written consent of MASAS.</p>
			...
			<p>These Terms of Use, together with the Community Guidelines, Privacy Policy and Cookies Policy, constitute the entire agreement between you and MASAS with respect to your use of the Platform (other than any use of MASAS's APIs (when and if available) which may also be subject to separate API Terms of Use), and supersede any prior agreement between you and MASAS. Any modifications to this Agreement must be made in writing.</p>



			<h2>Third Party Rights</h2>

			<p>These Terms of Use are not intended to give rights to anyone except you and MASAS. This does not affect our right to transfer our rights or obligations to a third party as described in the Assignment to Third Parties section.</p>



			<h2>Applicable Law and Jurisdiction</h2>

			<p>Except where otherwise required by the mandatory law of the United States or any member state of the European Union:

				<ol>
					<li>This Agreement is subject to the laws of the Republic of France (Civil Law), excluding the UN Convention on Contracts for the International Sale of Goods (CISG) and excluding the principles of conflict of laws (international private law); and, </li>
					<li>You hereby agree, and MASAS agrees, to submit to the exclusive jurisdiction of the courts in Paris, France for resolution of any dispute, action or proceeding arising in connection with this Agreement.</li>
				</ol>
			</p>

			<p>The foregoing provisions of this Applicable Law and Jurisdiction section do not apply to any claim in which MASAS seeks equitable relief of any kind. You acknowledge that, in the event of a breach of this Agreement by MASAS or any third party, the damage or harm, if any, caused to you will not entitle you to seek injunctive or other equitable relief against MASAS, including with respect to Your Content, and your only remedy shall be for monetary damages, subject to the limitations of liability set forth in these Terms of Use.</p>


			<h2>Disclosures</h2>

			<p>The services hereunder are offered by MASAS SAS, a company incorporated under the laws of Republique Francaise and with its main place of business at 2 Rue Bellanger, Neuilly-Sur-Seine, 92200, France. You may contact us by emailing us at: contact (@) MASAS.FM.</p>

			<h4>Emails used throughout this document:</h4>
